...
[O] **Still reserved** — INV-2 **clause 2**, that a Definition *implements at least one Capability*. Checking a Definition against Capabilities is the reserved construction discipline (`agent_spec §12`/`§13`, Agent Factory) and is neither enforced nor assumed by this boundary.

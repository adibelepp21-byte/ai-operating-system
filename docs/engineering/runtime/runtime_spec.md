...
## 14. Open Questions
[O] Runtime state model (which lifecycle states). [O] Resumable-state discipline distinct from Trace. [O] Runtime↔Workflow relationship ratification (currently Inferred).

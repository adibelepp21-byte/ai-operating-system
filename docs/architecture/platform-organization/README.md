...
| `DIVISION-OPERATION-AND-PERFORMANCE-MODEL.md` | The `D1`–`D10` operating chain and `E1`–`E10` performance chain from PD-01's resident frozen bodies · `G-10`. **Assigns nothing** |
...
| `EVIDENCE-FABRIC.md` | Link-integrity test of the eleven-node connective chain. **4 established · 2 indirect · 4 unknown**; `Intelligence` is not a frozen entity or layer |

# P13 Blueprint — **NON-CANONICAL DRAFT** v0.3
...
> ```
>
> **Revision authority:** [`ACT-CC-P13-006`](../../governance/acts/ACT-CC-P13-006-O5-EVIDENCE-VERIFICATION-AND-CLASSIFICATION-EXHAUSTION-ACT.md)
> — Founder-issued, under `FD-P13-004` Option D. **Scope: `O5` evidence only.**
> **Baseline:** `…v0.2…` `sha256 a4095a33…9c57` · **PRESERVED, UNMODIFIED**
> **Predecessor:** `…v0.1…` `sha256 75775cbd…d5f1` · **PRESERVED, UNMODIFIED**
>
> **Minimum change.** Only `O5` and the material it directly carries differ
> from v0.2. `ACT-CC-P13-006 §20`: *"Minimum change necessary to make `O5`
> evidence truthful, auditable, and correctly classified."* No architectural
> section was rewritten (`§14`, `§19`).
>
> ```text
...
```text
ACT-CC-P13-006         = EXECUTION COMPLETE  (O5 scope)
EXHAUSTION             = EXHAUSTED_WITH_CLASSIFIED_REMAINDER

P13 BLUEPRINT          = NON-CANONICAL DRAFT v0.3 — EXISTS
...
**This draft is a proposal to the Founder and nothing else.** v0.3 differs
from v0.2 in one place only: `O5` now names its seven sources instead of
counting them, and says plainly what that does not prove.

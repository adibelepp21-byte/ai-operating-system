# Interactive Governance Session Substrate
...
- **Name:** Interactive Governance Session Substrate
- **Canonical Key:** `runtime.interactive-governance-session-substrate`
...
An execution substrate (Domain Model §2) capable of running a Skill or
Workflow within a single, ongoing session directed by an Architect,
where the next step may depend on the previous step's output. Stated
...
Records, for this Runtime, the current representation of the boundary

...
Bounded by the grant's own terms, recorded at `docs/architecture/p11/w4-operations/4313bd2246124a94.delegation.json`. This projection adds no boundary and relaxes none; the ledger record is authoritative for scope, lifecycle and termination.
...
[execution evidence](../../p11/w4-operations/first-execution.evidence.json)

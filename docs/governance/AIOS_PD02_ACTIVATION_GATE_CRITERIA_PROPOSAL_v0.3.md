...
**Version:** v0.3 · **Supersedes:** v0.2 (v0.1 and v0.2 retained as provenance)
**Prepared under:** FOUNDER · `ACT-CC-F03-029 §11`, `§13`, `§20`
...
| **Evidence Source** | **EVIDENCE NOT ESTABLISHED.** Scans returned 3 candidates, all eliminated: the Activation Model's GG-2 *status* row; `GDR-0023`'s statement of the gap (*"No source defines what activation confers or requires"*); `ACT-CC-T4.4:120`, which concerns **Co-Founder office** activation — a different construct. Re-derived by an independent sentence-level scan: **0** |
...
| **Founder Decision Dependency** | **YES** — `ACT-CC-F03-028 §10`. Unanswerable without it |
...
| **Evidence Source** | **PARTIALLY ESTABLISHED.** 18/50 bodies reference PD-03…PD-10 (PD-03 ×12 · PD-04 ×6 · PD-05 ×16 · PD-06 ×11 · PD-07 ×10 · PD-08 ×6 · PD-09 ×7 · PD-10 ×13; independently re-derived at 18/50). PD-02 declares itself keeper of *"reference architecture"* that is *"acuan structural bagi pengembangan AIOS."* What consumers may do once PD-02 is active is **not** established — it depends on AGC-01 |
...
| **Founder Decision Dependency** | **INDIRECT** — via AGC-01 |
...
|---|---|---|
| AGC-01 | **FAIL** | No resident instrument defines what activation confers |
| AGC-02 | **UNRESOLVED** | Consumers enumerable; reliance undefined pending AGC-01 |
| AGC-03 | **PASS** | All four sources recompute and match |
| AGC-05 | **PASS** | Zero instruments grant Co-Founder activation authority |
| AGC-06 | **FAIL** | Neither change-control procedure nor revocation mechanism is resident |

**These criteria were not written to be passable.** Two fail and one is unresolved
on present evidence. Criteria drafted so the Volume clears them would certify
nothing.
